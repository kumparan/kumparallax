...
var EmojiSuggestions = function (_Component) {
  ...
  function EmojiSuggestions() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(EmojiSuggestions)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
      isActive: false,
      ...
      var filteredValues = _shortNames2.default.filter(function (emojiShortName) {
